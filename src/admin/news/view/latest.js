...
$(document).ready(function () {
    ...
    if ($('#dtLatest').length > 0) {
        ...
        let col_draft = [
            ...
            },
            {
                ...
                render: function (data, type, row) {
                    return `<a href="${domain_url}admin/news/show/latest/view/${data.uuid}"><span class="p-2 rounded-full shadow-md text-white" style="background-color:#2edcdc;"><i class="fa fa-eye"></i></span></a>
        ...
        makeAjaxDataTable('dtLatest', {
            select: false,
            url: 'admin/news/show/latest/list',
            columns: col_draft,
            pdf: [0, 1, 3, 4, 6, 7],
        });
    }
...
window.dtLatest = (table, api, op) => {
    downloadPdf({ ...op, btn: 'downloadLatestPdf', dataTable: 'yes' });
    downloadExcel({ ...op, btn: 'downloadLatestExcel', dataTable: 'yes' });
};