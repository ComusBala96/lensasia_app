...
$(document).ready(function () {
    ...
    if ($('#dtApproved').length > 0) {
        ...
        let col_draft = [
            ...
            },
            {
                ...
                render: function (data, type, row) {
                    return `<a href="${domain_url}admin/news/show/approved/view/${data.uuid}"><span class="p-2 rounded-full shadow-md text-white" style="background-color:#2edcdc;"><i class="fa fa-eye"></i></span></a>
        ...
        makeAjaxDataTable('dtApproved', {
            select: false,
            url: 'admin/news/show/approved/list',
            columns: col_draft,
            pdf: [0, 1, 3, 4, 6, 7],
        });
    }
...
window.dtApproved = (table, api, op) => {
    downloadPdf({ ...op, btn: 'downloadApprovedPdf', dataTable: 'yes' });
    downloadExcel({ ...op, btn: 'downloadApprovedExcel', dataTable: 'yes' });
};